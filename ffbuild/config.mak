...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=android --prefix=/work/mm_jiamin.zhu/asm/source/vendor/oplus/multimedia/mmserver/oplusmedia/libffmpeg_utils/ffmpeg_cm_14_1/android/armv8-a --arch=aarch64 --sysroot=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/sysroot --cross-prefix=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android- --cc=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android29-clang --cxx=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android29-clang++ --enable-cross-compile --enable-shared --enable-neon --enable-pic --enable-asm --enable-libdav1d --disable-static --disable-ffplay --disable-network --disable-ffmpeg --disable-ffprobe --disable-doc --disable-symver --disable-avdevice --disable-avfilter --disable-devices --disable-filters --disable-encoders --disable-muxers --extra-cflags='-march=armv8-a -Iextend/dav1d/include' --extra-ldflags=-Lextend/dav1d/armv8-a --extra-libs=-ldav1d
prefix=/work/mm_jiamin.zhu/asm/source/vendor/oplus/multimedia/mmserver/oplusmedia/libffmpeg_utils/ffmpeg_cm_14_1/android/armv8-a
...
INTRINSICS=neon
EXTERN_PREFIX=
CC=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android29-clang
CXX=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android29-clang++
AS=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android29-clang
OBJCC=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android29-clang
LD=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android29-clang
DEPCC=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android29-clang
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android29-clang
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
DEPX86ASMFLAGS=$(X86ASMFLAGS)
AR=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android-ar
ARFLAGS=rcD
AR_O=$@
AR_CMD=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android-ar
NM_CMD=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android-nm -g
RANLIB=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android-ranlib -D
STRIP=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android-strip
STRIPTYPE=direct
NVCC=clang
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/sysroot -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -march=armv8-a -Iextend/dav1d/include -std=c11 -fPIE -fomit-frame-pointer -fPIC -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -march=armv8-a -Iextend/dav1d/include -fPIC -g -Qunused-arguments
...
LD_PATH=-L
DLLTOOL=
WINDRES=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android-windres
DEPWINDRES=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android29-clang
DOXYGEN=doxygen
LDFLAGS= -Lextend/dav1d/armv8-a  --sysroot=/work/mm_jiamin.zhu/android-ndk-r20/toolchains/llvm/prebuilt/linux-x86_64/sysroot -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample -Qunused-arguments
LDEXEFLAGS= -fPIE -pie
LDSOFLAGS=
